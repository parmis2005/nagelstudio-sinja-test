  ...
  return (
    <section id="kontakt" className="bg-white py-20 sm:py-24">
      <div className="mx-auto max-w-6xl px-5 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 overflow-hidden rounded-3xl bg-sand-50 shadow-sm ring-1 ring-rose-100 lg:grid-cols-5">
          <div className="flex flex-col justify-center gap-6 p-8 lg:col-span-2 lg:p-10">
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-start gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="mt-0.5 h-5 w-5 shrink-0 text-rose-500">
                ...
                <div>
                  <p className="text-foreground/80">{fullAddress}</p>
                  <a
              ...
              <div className="flex items-start gap-3">
                ...
                <a href={business.phoneHref} className="font-medium text-rose-600 hover:text-rose-700">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <a
                ...
                className="rounded-full border border-rose-200 px-6 py-3 text-sm font-semibold text-rose-700 transition-colors hover:bg-rose-100"
              >
                Anrufen
              </a>
            </div>
