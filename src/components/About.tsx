        ...
        <div className="order-2 lg:order-1">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <a
              ...
              className="flex items-center gap-2 rounded-full border border-rose-200 px-6 py-3 text-sm font-semibold text-rose-700 transition-colors hover:bg-rose-100"
            >
